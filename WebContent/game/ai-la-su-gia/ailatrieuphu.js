...
$(document).ready(function () {
	var data = [{
    "question": "Sau chiến tranh thế giới lần thứ nhất, ở Việt Nam ngoài thực dân Pháp, còn có giai cấp nào trở thành đối tượng của cách mạng Việt Nam?",
    "options": ["Giai cấp nông dân", "Giai cấp công nhân", "Giai cấp đại địa chủ ", "Giai cấp tư sản, dân tộc"],
    "answer": "C"
  }, {
    "question": "Trong cuộc khai thác thuộc địa lần thứ hai, thực dân Pháp đầu tư vốn nhiều nhất vào các ngành nào?",
    "options": ["Công nghiệp chế biến.", "Nông nghiệp và khai thác mỏ", "Nông nghiệp và thương nghiệp", "Giao thông vận tải"],
    "answer": "B"
  }, {
    "question": "Văn Miếu Quốc Tử Giám - Trường đại học đầu tiên ở Việt Nam được xây dựng dưới triều đại nào ?",
    "options": ["Lê", "Trần ", "Lý", "Nguyễn"],
    "answer": "C"
  }, {
    "question": "Lực lượng nào hăng hái và đông đảo nhất của cách mạng Việt Nam sau chiến tranh thế giới thứ nhất?",
    "options": ["Công nhân", "Nông dân", "Tiểu tư sản", "Tư sản dân tộc"],
    "answer": "B"
  },{
    "question": "Vào thời gian nào, Nguyễn ái Quốc rời Pari đi Liên Xô, đất nước mà từ lâu Người mơ ước đặt chân tới?",
    "options": ["Tháng 6/1924", "Tháng 12/1924", "Tháng 12/1923", "Tháng 6/1923"],
    "answer": "D"
  },{
    "question": "Chi bộ cộng sản đầu tiên của nước ta được thành lập ở đâu?",
    "options": ["ở Nam Kì", "ở Bắc Kì", "ở Trung Kì", "ở Trung Quốc"],
    "answer": "B"
  },{
    "question": "Tổ chức cộng sản nào ra đời ở Trung Kì?",
    "options": ["Đông Dương cộng sản đảng", "An Nam cộng sản đảng", "Đông Dương cộng sản liên đoàn", "Cả ba tổ chức trên"],
    "answer": "C"
  },{
    "question": "Ai là trạng nguyên trẻ tuổi nhất nước Nam ?",
    "options": ["Mạc Đĩnh Chi", "Lương Thế Vinh", "Nguyễn Hiền", "Nguyễn Bỉnh Khiêm"],
    "answer": "C"
  },{
	"question": " 'Hiền tài là nguyên khí của quốc gia' là câu nói của ai ?",
	"options": ["Thân Nhân Trung", "Nguyễn Hiền", "Lê Quý Đôn", "Ngô Sĩ Liên"],
	"answer": "A"
  },{
    "question": "Cương lĩnh chính trị đầu tiên của Đảng do ai khởi thảo ?",
    "options": ["Trần Phú.", "Nguyễn Ái Quốc", "Lê Hồng Phong", "Nguyễn Văn Cừ"],
    "answer": "B"
  },{
	"question": "Hội nghị Ban chấp hành Trung ương Đảng lần thứ nhất đã quyết định đổi tên Đảng ta thành:",
	"options": ["Đảng Cộng Sản Việt Nam", "Đảng Cộng Sản Đông Dương", "Đông Dương Cộng Sản Đảng", "Đảng Lao động Việt Nam"],
	"answer": "D"
  },{
	"question": "Lệ Chi Viên là khu vườn trồng loại cây gì ?",
	"options": ["Vải ", "Táo", "Nho ", "Ổi"],
	"answer": "A"
  },{
	"question": "Hệ thống Đảng trong nước nói chung đã được khôi phục vào thời gian nào?",
	"options": ["Đầu năm 1932", "Đầu năm 1933", "Cuối năm 1935", "Cuối năm 1934 đầu năm 1935"],
	"answer": "D"
  },{
	"question": "Vị Vua có nhiều vợ nhất ?",
	"options": ["Trần Dụ Tông", "Lê Đại Hành", "Khải Định", "Minh Mạng"],
	"answer": "D"
  },{
	"question": "Người phụ nữ nào trong lịch sử Việt Nam đã trở thành hoàng hậu của 2 triều đại ?",
	"options": ["Ỷ Lan", "Dương Vân Nga", "Văn Đức", "Nam Phương"],
	"answer": "B"
  }];
    ...
    Millionaire = (function () {
        ...
        Millionaire.prototype.nextQ = function () {
            ...
            if (step % 5 == 0) {
                ...
                $("#question-number").css("background-color", "#632601");
        ...
        Millionaire.prototype.updateValue = function () {
            ...
            var index = (this._boardPage) * 5;
			var j=0;
            _this._questionContent[this._boardPage] = data[i].question;
            _this._answerArray[this._boardPage] = "box" + data[i].answer;
            this._questionArray[index] = data[i].options[j];
            this._questionArray[index + 1] = data[i].options[j+1];
            this._questionArray[index + 2] = data[i].options[j+2];
            this._questionArray[index + 3] = data[i].options[j+3];
            this._questionArray[index + 4] = data[i].answer;
			i++;
        };
        ...
        Millionaire.prototype.withdraw = function () {
            ...
            var message = "Bạn đã dừng cuộc chơi và giữ mức thưởng ở Câu " + this._boardPage;
        ...
        Millionaire.prototype.resetBoardStatus = function () {
            $("#boxA").css('background-color', 'rgba(0, 0, 0, 0.5)');
            $("#boxB").css('background-color', 'rgba(0, 0, 0, 0.5)');
            $("#boxC").css('background-color', 'rgba(0, 0, 0, 0.5)');
            $("#boxD").css('background-color', 'rgba(0, 0, 0, 0.5)');
            $("#boxA").empty();
            $("#boxB").empty();
            $("#boxC").empty();
            $("#boxD").empty();
        ...
        Millionaire.prototype.selectBox = function (boxID) {
            ...
            if (boxID == "boxA" || boxID == "boxB" || boxID == "boxC" || boxID == "boxD") {
                ...
                $(id).css('background-color', 'rgba(63, 81, 181, 0.69)');
        ...
        Millionaire.prototype.nextOrStop = function () {
            ...
            if (this.checkResult(this._boardPage)) {
                ...
                $("#alert").html("Chúc mừng! Câu trả lời của bạn rất chính xác!");
                _this._color = 'rgba(63, 81, 181, 0.69)';
                if (page + 1 == _this._answerArray.length) {
                    $("#alert").attr("class", "alert alert-success");
                    $("#alert").html("Chúc mừng! Bạn vượt qua " + _this._answerArray.length + " câu hỏi của trò chơi.");
                    this.show($('#restart-game'));
                    this.hide($('#next-question'));
                ...
                if (page >= 10) {
                    message = "Bạn nhận được phần thưởng cho câu hỏi số 10."
                } else if (page >= 5) {
                    message = "Bạn nhận được phần thưởng cho câu hỏi số 5."
                } else {
                    message = "Bạn không có phần thưởng."
                }
        ...
        Millionaire.prototype.congrats = function () {
            this._interval = setInterval(function () {
                if (_this._hover) {
                    $('.answerBox').css('background-color', 'rgba(76, 175, 80, 0.44)');
        ...
        Millionaire.prototype.clearWrong = function (boxName1, boxName2) {
            ...
            $(boxName1).css('background-color', 'rgba(0, 0, 0, 0.5)');
            $(boxName2).css('background-color', 'rgba(0, 0, 0, 0.5)');
...
$(document).ready(function(){
	  $('#create-game-button').trigger('click');
	});