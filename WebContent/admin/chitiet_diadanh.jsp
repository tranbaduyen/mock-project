...
<div class="left-content">
	   <div class="mother-grid-inner">
               <!--header start here-->
				...
				<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Trang Chủ</a><i class="fa fa-angle-right"></i><a href="inbox.html">Hộp Thư</a><i class="fa fa-angle-right"></i>Đóng Góp</li>
            </ol>
<!--grid-->
