...
<div class="left-content">
	   <div class="mother-grid-inner">
			...
			<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="admin.jsp">Trang Chủ</a><i class="fa fa-angle-right"></i>Nhân Vật Lịch Sử</li>
            </ol>
                        ...
                        <div class="">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
								...
								<tbody>
                                	...
                                	<logic:iterate name="danhSachNhanVatForm" property="listNhanVat" id="nv">
						            	<tr>
							                <td scope="row">
							                	<bean:write name="nv" property="maNhanVat"/>
											</td>
							                <td>
							                	<bean:write name="nv" property="tenNhanVat"/>
							                </td>
							           		<td>
							                	<bean:write name="nv" property="namSinh"/>
							                </td>
							                <td>
							                	<bean:write name="nv" property="namMat"/>
							                </td>
							                <td>
							                	<div class="img-list"><img src = "../../<bean:write name="nv" property="hinhAnh"/>" alt = "hinhAnh"/>
							                	</div>
							                </td>
							                <td>
							                	<bean:define id="maNhanVat" name="nv" property="maNhanVat"></bean:define>
							                	<html:link action="/admin/quanlybaiviet/suaNV?maSuKien=${maNhanVat}">
							                		<span class="glyphicon glyphicon-edit"> Sửa</span>
							                	</html:link>
							                	<html:link action="/admin/quanlybaiviet/xoaNV?maSuKien=${maNhanVat}">
