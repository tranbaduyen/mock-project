...
<!--grid-->
 	...
 	<!---->
        ...
        <html:form action="/admin/quanlybaiviet/suaGD" method="post">
        	<div class="col-md-12 form-group1 group-mail">
              	<label class="control-label">Mã Giai Đoạn</label>
              	<html:text property="maGiaiDoan" styleClass="form-control" readonly="true"></html:text>
            </div>
			<div class="col-md-12 form-group1 group-mail">
              	...
              	<html:select property="maThoiKi" styleClass="form-control">
					...
					<html:optionsCollection name="giaiDoanForm" property="listThoiKi" label="tenThoiKi" value="maThoiKi" />
				</html:select>
            </div>
            <div class="col-md-12 form-group1 group-mail">
            ...
            <!-- #END# CKEditor -->
            <div class="col-md-12 form-group1 group-mail">
              <label class="control-label">Bản Đồ Giai Đoạn</label>
              <html:img src="../../assets/images/in.jpg/" styleClass="form-control"></html:img>
            </div>
             <div class="clearfix"> </div>
